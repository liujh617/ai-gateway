...
首期不支持 `previous_response_id`、`store: true`、Conversations、tools、tool calls/tool outputs、reasoning Items、图片、音频、文件、多模态、background mode、WebSocket 和其他未知字段。这些字段不会被静默忽略，而是稳定返回 `400 invalid_request_error`。
